    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<BusinessCardContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("BusinessCardDatabase")));
            //services.AddDbContext<BusinessCardContext>(o=>o.UseSqlite(Configuration.GetConnectionString("BloggingDatabase")));
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    Description="API for business cards"
                });
            });
        }
